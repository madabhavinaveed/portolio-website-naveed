  ...
  const skillCategories = [
    {
      ...
      skills: ["React.js", "Vue.js", "Angular.js", "HTML5", "CSS3", "JavaScript", "Tailwind CSS", "SCSS"]
    },
    {
      title: "Backend & APIs",
      skills: ["Node.js", "GraphQL", "REST APIs", "RPC Calls", "Web3", "Smart Contracts"]
    },
    {
      title: "Management Tools",
      skills: ["Trello", "Confluence", "Jira", "Azure DevOps", "GitHub", "Bitbucket"]
    },
    {
      title: "Technologies & Platforms",
      skills: ["OpenCart", "Shopify", "WordPress", "AWS (EC2, S3, IAM)", "DevOps", "Linux"]
    },
    {
      title: "Databases",
    ...
    },
    {
      ...
      skills: ["Redux", "Vuex", "React Native", "Ionic", "jQuery", "Webpack", "CodeAI"]
    }
  ];
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 animate-scale-in">
          {skillCategories.map((category, index) => (
            <Card key={index} className="shadow-card border-0 hover:shadow-glow transition-all duration-300 hover:-translate-y-1">
