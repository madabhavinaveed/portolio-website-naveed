...
const portfolioItems = [
  ...
  },
  {
    ...
    description: "Clean and intuitive mobile app interface for fitness tracking",
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Explore some of my recent work and successful projects delivered through freelance platforms
        </p>
      </div>
          ...
          <Card key={index} className="group overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <Button size="sm" variant="secondary" onClick={() => window.open(item.link, "_blank")}>
