    ...
    <div className="container mx-auto max-w-5xl">
      ...
      >
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="space-y-4 text-white leading-relaxed"  style={{ textAlign: 'justify' }}>
            <p>
          ...
          >
            <a href="https://www.linkedin.com/in/naveed-madabhavi-0888b22a5/" className="text-muted-foreground" target="_blank" rel="noopener noreferrer" >
